...
const Popover = createClass({
  ...
  trackPopover () {
    ...
    this.bodyEl = this.containerEl.querySelector(`.cf-popover-body`)
    this.tipEl = this.containerEl.querySelector(`.cf-popover-tip`)
  ...
  renderLayer () {
    ...
    const popoverProps = {
      className: `cf-popover cf-uiContainer ${className}`,
    ...
    return (
      E.div(popoverProps,
        E.div({ className: `cf-popover-body` }, ...popoverBody),
